...
class CollectionUtils {
     ...
     */
    static <T> boolean containsAll(@NotNull List<? extends T> c1, List<? extends T> c2) {
     ...
     */
    static <T> boolean containsAny(@NotNull List<? extends T> c1, @NotNull List<? extends T> c2) {
