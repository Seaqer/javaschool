...
class TerminalImpl implements Terminal {
    ...
    final static Log LOGGER = LogFactory.getLog(TerminalImpl.class);
     ...
     *
     */
    public String getStarted(String inputString) {
        try {
     ...
     * Выбрать операцию
     */
    public String callOpeartion(String id, String command, String pin, Integer sum) throws IllegalArgumentException, IllegalStateException, AccountIsLockedException {
        String answer = "";
     ...
     */
    public String getStateAccount(String id) throws IllegalStateException {
     ...
     */
    public String putCash(String id, int sum) throws IllegalArgumentException, IllegalStateException {
     ...
     */
    public String takeCash(String id, int sum) throws IllegalArgumentException, IllegalStateException {
    ...
    public String setWork(String pin) {
        try {
            if (pinValidator.validate(pin)) {
